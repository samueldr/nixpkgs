...
++ optionals (stdenv.targetPlatform.isBtron && is12) [
  ./brightv/12-0001-brightv-Inelegantly-hack-in-spec-configuration-for-B.patch
  ./brightv/12-0001-brightv-Inelegantly-replace-lc-with-lg.patch
]
